    ...
    <main className="account-shell">
      <section className="account-brand-panel">
        <div className="account-brand">
          ...
          <div><strong>Analog Studio</strong><span>模拟 IC 原理图工作台</span></div>
        </div>
      ...
      <section className="account-form-panel">
        <div className="account-form-wrap">
          <div className="account-mobile-brand"><Waves size={18} /> Analog Studio</div>
          <div className="account-form-heading">
            <span className="account-step">{isRegister ? "创建工作区账户" : "欢迎回来"}</span>
            <h2>{isRegister ? "注册账户" : "登录 Analog Studio"}</h2>
